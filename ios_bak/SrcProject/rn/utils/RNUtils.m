...
NSString * const SERVER_ROOT_PATH = @"http://www.weichuanghome.com/reading/";
...
+(BOOL) handleAppUpgradeWithSuccess:(DefaultSuccessBlock)success{
  ...
  [RNUtils getDataWithUrlStr:[SERVER_ROOT_PATH stringByAppendingString:@"reading/json/checkVersions"] withParam:param_checkVersions withSuccess:^(NSDictionary *RES_DATA, BOOL isSuccess) {
...
//        [params_jsbundle setValue:appBundleV forKey:@"appBundleV"];
        ...
        [RNUtils downloadFileWithUrlStr:[SERVER_ROOT_PATH stringByAppendingString:@"reading/byte/downloadFile"] withParam: params_jsbundle withSuccess:^() {
          // 获取沙盒主目录路径
          ...
          [RNUtils downloadFileWithUrlStr:[SERVER_ROOT_PATH stringByAppendingString:@"reading/byte/downloadFile"] withParam:params_assets withSuccess:^() {
            //
