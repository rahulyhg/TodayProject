...
var AccountPwdAddView = require('./AccountPwdAddView.js');
var AccountPwdUpdView = require('./AccountPwdUpdView.js');
var AccountPwdDetailView = require('./AccountPwdDetailView.js');
...
//
var NavigatorAccountPwdInner = React.createClass({
    ...
    _renderScene: function(route, navigator){
        ...
        var props = {};
        switch(route.name){
            case "AccountPwdAddView": //
                navigationBarRouteMapper.navigator = global.YrcnApp.now.rootNavigator;
                Component = AccountPwdAddView;
                break;
            case "AccountPwdUpdView": //
                navigationBarRouteMapper.navigator = global.YrcnApp.now.rootNavigator;
                Component = AccountPwdUpdView;
                break;
            case "AccountPwdDetailView": //
                navigationBarRouteMapper.navigator = global.YrcnApp.now.rootNavigator;
                Component = AccountPwdDetailView;
                break;
            case "ForgetPwdView": //
...
//
module.exports = NavigatorAccountPwdInner;