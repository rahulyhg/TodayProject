...
var CardPwdAddView = require('./CardPwdAddView.js');
var CardPwdUpdView = require('./CardPwdUpdView.js');
var CardPwdDetailView = require('./CardPwdDetailView.js');
...
//
var NavigatorCardPwdInner = React.createClass({
    ...
    _renderScene: function(route, navigator){
        ...
        switch(route.name){
            case "CardPwdAddView": //
                ...
                Component = CardPwdAddView;
                break;
            case "CardPwdUpdView": //
                navigationBarRouteMapper.navigator = global.YrcnApp.now.rootNavigator;
                Component = CardPwdUpdView;
                break;
            case "CardPwdDetailView": //
                navigationBarRouteMapper.navigator = global.YrcnApp.now.rootNavigator;
                Component = CardPwdDetailView;
                break;
            case "ForgetPwdView": //
...
//
module.exports = NavigatorCardPwdInner;