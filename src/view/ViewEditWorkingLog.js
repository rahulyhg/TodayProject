    ...
    render: function(){
        ...
        return (
            <View style={styles.container}>
                <ViewHeader title="工作日志" onPressLeft={this._onPressLeft} leftText="完成"/>
                <FormBox>
                    <FormBox.InputArea placeholder={"请输入工作内容..."} keyboardType={"default"}  maxLength={200}
                    ...
                    {function(){
                        if(_this.state.overtime){
                            return (
                                <FormBox.InputArea placeholder={"请输入加班描述..."} keyboardType={"default"}  maxLength={200}
                    ...
                    {function(){
                        if(_this.state.qingjia){
                            return (
                                <FormBox.InputArea placeholder={"请输入请假/调休描述..."} keyboardType={"default"}  maxLength={200}
