...
var ListViewAccountPwd = require('./ListViewAccountPwd.js');
//
...
var NavigatorMyLife = React.createClass({
    ...
    render: function(){
        ...
        return (
            <Navigator
                initialRoute={{name: 'ListViewMyLifes', index: 0,title:"账号密码"}}
                navigationBar={
