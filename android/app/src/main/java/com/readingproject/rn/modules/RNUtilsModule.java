package com.readingproject.rn.modules;
...
import com.readingproject.UpdateManager;
...
//        retMap.putString("appUpgradeDesp","");
    ...
    @ReactMethod
    public void appUpgrade(ReadableArray params, Callback successCallback) {
        final WritableNativeMap retMap = new WritableNativeMap();
        //
